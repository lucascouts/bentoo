...
EGIT_COMMIT="2e56788ec45c955c19f4b7bf5d5f6cacb1d3a4c8"
SRC_URI="https://github.com/google/${PN}/archive/${EGIT_COMMIT}.zip -> ${P}.zip"
...
RDEPEND="
	>=dev-util/glslang-1.4.304.0:=[${MULTILIB_USEDEP}]
	>=dev-util/spirv-tools-1.4.304.0[${MULTILIB_USEDEP}]
"
DEPEND="${RDEPEND}
	${PYTHON_DEPS}
