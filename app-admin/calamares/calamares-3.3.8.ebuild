...
SLOT="5"
KEYWORDS="~amd64"
IUSE="+bootloader +btrfs +displaymanager doas +finished +fstab +grubcfg +keyboard +locale +machineid +mount +networkmanager +packages +partition pythonqt qt6 +removeuser +services-openrc +shellprocess +umount +unpackfs +upower +users webview +welcome"
