...
SRC_URI="https://github.com/audacity/audacity/releases/download/${MY_P}/${PN}-${PV}-source.tar.gz
	doc? ( https://github.com/audacity/audacity/releases/download/${MY_P}/${PN}-manual-${PV}.tar.gz )"
