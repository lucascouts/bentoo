...
SRC_URI="
	...
	https://dev.gentoo.org/~mpagano/dist/intel-microcode/intel-microcode-collection-${OLD_COLLECTION}.tar.xz
	https://dev.gentoo.org/~sam/distfiles/${CATEGORY}/${PN}/intel-microcode-collection-${OLD_COLLECTION}.tar.xz
"
S="${WORKDIR}"
