...
#	"${FILESDIR}"/${PN}-1.4-poppler-24.10-fix-backport.patch
	"${FILESDIR}"/${PN}-1.4-poppler-24.{11,12}.0.patch # bugs 943499, 946597.
	"${FILESDIR}"/${PN}-1.4-poppler-25.{02,06}.0.patch # bugs 949531, 957137
	"${FILESDIR}"/${PN}-1.4-poppler-25.07.0.patch # pending for git master
	"${FILESDIR}"/${PN}-1.4-cmake4.patch
)
