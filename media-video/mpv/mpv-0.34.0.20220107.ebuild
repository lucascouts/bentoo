...
if [[ ${PV} != *9999* ]]; then
	EGIT_COMMIT="d09c73c7b2b0135cb24ab2173b3c4ee1c55840b0"
	SRC_URI="https://github.com/mpv-player/mpv/archive/${EGIT_COMMIT}.tar.gz -> ${P}.tar.gz"
	KEYWORDS="~alpha amd64 ~arm ~arm64 ~hppa ppc ppc64 ~riscv x86 ~amd64-linux"
	DOCS=( RELEASE_NOTES )
	S="${WORKDIR}/mpv-${EGIT_COMMIT}"
else
