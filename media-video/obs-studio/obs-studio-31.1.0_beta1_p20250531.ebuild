...
CEF_REVISION="_v3"
OBS_COMMIT="9bd4514b45a8150328190cd6bc3d2dbf00ebfd3b"
OBS_BROWSER_COMMIT="5ee805695d337cbea4180fd25e5b86bfff4af33b"
OBS_WEBSOCKET_COMMIT="79cd0c729e46cae785d2035d9d7ffe1379adbe7e"
...
if [[ ${PV} == 9999 ]]; then
	...
	SRC_URI="
		https://github.com/obsproject/${PN}/archive/${OBS_COMMIT}.tar.gz
			-> ${P}.tar.gz
